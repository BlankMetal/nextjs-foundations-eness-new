// Lesson 2.6: Navigation
// Demonstrates soft navigation with next/link vs hard navigation with <a>
...
export default async function NavDemoPage() {
  // Opt out of prerendering so Date.now() reflects actual request time
  await connection();
  ...
  return (
    <main className="mx-auto max-w-2xl p-8">
      ...
      <div className="space-y-6">
        {/* --- Section 1: Soft Navigation with <Link> --- */}
        ...
        {/* --- Section 2: Hard Navigation (plain <a>) --- */}
        <section className="rounded-lg border p-4">
          <h2 className="mb-4 font-semibold text-xl">
        ...
        {/* --- Section 3: Programmatic Navigation (useRouter) --- */}
        <section className="rounded-lg border p-4">
          <h2 className="mb-4 font-semibold text-xl">
        ...
        {/* --- Section 4: State Preservation Proof --- */}
        <section className="rounded-lg border p-4">
      ...
      <div className="mt-8 rounded bg-gray-100 p-4">
        ...
        <ul className="list-inside list-disc space-y-1 text-gray-600 text-sm">
          ...
          <li>
            <strong>redirect():</strong> Server-side navigation
          </li>
        </ul>
      </div>
    </main>
